...
def draw_overlay(
    ...
    # Consistent weather box 250 x 110 px
    ...
    # Consistent train box 198 x 110 px
    TRAIN_BOX_WIDTH, TRAIN_BOX_HEIGHT = (
        SIZE_X - WEATHER_BOX_WIDTH,
    ...
    if weather and sum(forecast.precipitation_intensity for forecast in weather.forecasts) > 0:
        ...
        image.paste(
            graph_img, (0, SIZE_Y - WEATHER_BOX_HEIGHT - RAIN_BOX_HEIGHT), graph_img
        )
